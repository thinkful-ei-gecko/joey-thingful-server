...
- To seed the database for development: `psql -U dunder_mifflin -d thingful -a -f seeds/seed.thingful_tables.sql`
- To clear seed data: `psql -U dunder_mifflin -d thingful -a -f seeds/trunc.thingful_tables.sql`
